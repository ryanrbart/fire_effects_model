...
tec_data[3,] <- data.frame(2091, 09, 30, 1, "output_current_state", stringsAsFactors=FALSE)
tec_data[3,] <- data.frame(2141, 09, 30, 1, "output_current_state", stringsAsFactors=FALSE)
