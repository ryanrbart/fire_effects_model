...
if ($2 == "DELETE") 
	...
	printf("%f %s\n0.205 cs_leafc\n",$1,$2); a=1; h=1;
	printf("%f %s\n0.0 cs_dead_leafc\n",$1,$2); a=1; h=1;
	printf("%f %s\n0.013 cs_leafc_store\n",$1,$2); a=1; h=1;
	printf("%f %s\n0.0 cs_leafc_transfer\n",$1,$2); a=1; h=1;
	printf("%f %s\n0.003 cs_live_stemc\n",$1,$2); a=1; h=1;
	printf("%f %s\n0.001 cs_livestemc_store\n",$1,$2); a=1; h=1;
	printf("%f %s\n0.0 cs_livestemc_transfer\n",$1,$2); a=1; h=1;
	printf("%f %s\n3.2 cs_dead_stemc\n",$1,$2); a=1; h=1;
	printf("%f %s\n0.012 cs_deadstemc_store\n",$1,$2); a=1; h=1;
	printf("%f %s\n0.0 cs_deadstemc_transfer\n",$1,$2); a=1; h=1;
	printf("%f %s\n0.0005 cs_live_crootc\n",$1,$2); a=1; h=1;
