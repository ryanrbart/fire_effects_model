...
sens_model_runs = function(thresh_over=5,thresh_under=3,pspread_loss_rel=1,vapor_loss_rel=1,biomass_loss_rel_k1=-0.02,biomass_loss_rel_k2=200,pspread=.5,c_under=.1){
...
thresh_over = seq(4,4,length.out = 1)           # default: 5
...
biomass_loss_rel_k1 = seq(-0.02,-0.02,length.out = 1)       # default: ?
biomass_loss_rel_k2 = seq(200,200,length.out = 1)           # default: ?
pspread =  seq(0.1,1,length.out = 40)
c_under = seq(1,1,length.out = 1)

fire_sensitivity = sens_model_runs(thresh_over=thresh_over,thresh_under=thresh_under,vapor_loss_rel=vapor_loss_rel,pspread=pspread)
fire_sensitivity
